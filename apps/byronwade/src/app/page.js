...
export default async function Home() {
  return (
    <div className="shadow-inner bg-white2">
      <div className="flex items-center w-full px-4 duration-300 ease-in-out rounded-md h-14">
        <div className="hidden mr-4 md:flex">
          ...
          <nav className="flex items-center gap-6 text-sm">
            ...
            <a
              className="hidden transition-colors text-foreground/60 hover:text-foreground/80 lg:block"
        ...
        <div className="flex items-center justify-between flex-1 space-x-2 md:justify-end">
          <nav className="flex items-center">
            <a target="_blank" rel="noreferrer" href="https://github.com/byronwade">
              <div className="inline-flex items-center justify-center px-0 py-2 text-sm font-medium transition-colors rounded-md whitespace-nowrap focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-9 w-9">
            ...
            <a target="_blank" rel="noreferrer" href="https://twitter.com/byron_c_wade">
              <div className="inline-flex items-center justify-center px-0 py-2 text-sm font-medium transition-colors rounded-md whitespace-nowrap focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-9 w-9">
                <svg
