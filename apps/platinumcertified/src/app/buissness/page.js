...
const business = {
  address: '7737 CA-9, Ben Lomond, CA 95005, USA',
  brandConsistencyScore: '9.2',
  ...
  categories: [
    ...
    {
      alias: 'emergencyplumbing',
      title: 'Emergency Plumbing'
    }
  ],
  coordinates: {
    latitude: 37.0691829,
    longitude: -122.084144
  },
  currentOpeningHours: {
    openNow: true,
    periods: [
  ...
  description:
    "Wade's Plumbing & Septic offers 24/7 emergency plumbing and septic services across Santa Cruz, Monterey, and Santa Clara Counties. With an experienced team ready to assist anytime, any day, they are the go-to for all plumbing and septic needs.",
  email: 'support@wadesinc.io',
  googleMapsLink: 'https://maps.google.com/?cid=7910009961732981689',
  googleQuery: "Wade's Plumbing & Septic Santa Cruz Monterey Santa Clara",
  googleRating: 4.9,
  googleRatingCount: 44,
  googleReviews: [
    // Sample review objects
  ],
  image_url: 'https://s3-media3.fl.yelpcdn.com/bphoto/9QAUZZsQShOw6HWIokCpOQ/o.jpg',
  location: {
    address1: '7737 CA-9, Ben Lomond, CA 95005, USA'
  },
  ...
  sentimentScore: '8.5',
  website: 'https://www.wadesplumbingandseptic.com',
  yelpRating: 4.5,
  yelpRatingCount: 15,
  yelpReviews: [
    // Sample review objects
